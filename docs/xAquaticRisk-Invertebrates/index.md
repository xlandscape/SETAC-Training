...
|-----------|-------------|
| XSprayDrift | Spray-drift deposition into waterbodies |
| CascadeToxswa / CmfContinuous | Environmental fate in stream networks |
| LEffectModel | Individual-level GUTS effects modelling |
| StreamCom | Population dynamics of aquatic invertebrates |
